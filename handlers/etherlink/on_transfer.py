...
from rollup_bridge_indexer.models import EtherlinkTokenHolder
from rollup_bridge_indexer.types.l2_token.evm_events.transfer import TransferPayload
...
async def on_transfer(
    ...
    ctx.logger.info('Etherlink Token Transfer Event found: %s', event.data.transaction_hash)
    ...
    ctx.logger.info('Token Holders Balance updated by %s.', amount)
